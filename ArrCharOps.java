...
public class ArrCharOps {
    public static void main(String[] args) {
       ...
       // System.out.println(str);  // Prints the string
        ...
        System.out.println(indexOf(arr1,'c'));  
        System.out.println(indexOf(arr1,'y',4)); 
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        char[] newC = new char[arr1.length+arr2.length];
        for(int i=0;i<arr1.length;i++)
        {
            newC[i] = arr1[i];
        }
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        char[] newArr = new char[Math.abs(endIndex-beginIndex)];
        int j =0;
    ...
    public static int compareTo(String str1, String str2) {
        ...
        {
            if(str1.charAt(i)>str2.charAt(i))  finala = 1;
            if(str1.charAt(i)<str2.charAt(i)) finala = -1;
        }
        if(finala == 0)
        {
            if(str1.length()>str2.length()) finala = 1;
            if(str1.length()<str2.length()) finala = -1;
        }
